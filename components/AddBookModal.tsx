                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div className="mt-6 flex justify-end gap-3">
                      ...
                      <button
                        type="submit"
                        disabled={isSubmitting}
                        className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-lg transition-opacity disabled:opacity-50 min-w-[100px]"
                      >
                        {isSubmitting ? (
                          <Loader
                            size="sm"
